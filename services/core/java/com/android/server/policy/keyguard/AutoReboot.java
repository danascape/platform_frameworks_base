...
class AutoReboot {
    ...
    private static final int DEFAULT_TIMEOUT_MILLIS = (int) TimeUnit.HOURS.toMillis(18);
    ...
    static void onKeyguardShowingStateChanged(Context ctx, boolean showing, int userId) {
        ...
        final int timeoutMillis = Settings.Global.getInt(ctx.getContentResolver(),
                Settings.Global.AUTO_REBOOT_TIMEOUT, DEFAULT_TIMEOUT_MILLIS);
