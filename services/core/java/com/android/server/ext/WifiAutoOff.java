...
class WifiAutoOff extends DelayedConditionalAction implements WifiNetworkStateChangedListener {
    ...
    private WifiAutoOff(SystemServerExt sse) {
        super(sse, Settings.Global.WIFI_AUTO_OFF, 0 /* off by default */, sse.bgHandler);
    ...
    protected void registerStateListener() {
        ...
        var receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                currentWifiState = intent.getIntExtra(WifiManager.EXTRA_WIFI_STATE,
                        WifiManager.WIFI_STATE_UNKNOWN);
                Slog.d(TAG, "WIFI_STATE_CHANGED broadcast, state "
                        + wifiStateToString(currentWifiState));
